        ...
        <div className="container">
          <div className="row align-items-center">
            <div className="col-md-7">
              ...
              <p className="intro-text">I started in design and gradually fell in love with bringing ideas to life through both design and development. Now I build digital experiences that balance aesthetics, usability, and business goals.</p>
              <div className="mt-4">
                <Link
                  to="projects"
                  smooth={true}
